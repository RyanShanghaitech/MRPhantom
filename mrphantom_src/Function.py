...
def Enum2SS(arrPht:NDArray, ampCar:double=0e0, TR:double=None, TE:double=None, FA_deg:double=None, bSSFP:bool=False) -> NDArray:
    """
    ...
    mapSS *= genPhMap(arrPht.ndim, arrPht.shape[0])
    return mapSS
